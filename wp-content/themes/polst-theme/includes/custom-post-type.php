...
function custom_post_example() { 
	...
	register_post_type( 'custom_type', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			'name' => __( 'Custom Types', 'polst' ), /* This is the Title of the Group */
			'singular_name' => __( 'Custom Post', 'polst' ), /* This is the individual type */
			'all_items' => __( 'All Custom Posts', 'polst' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'polst' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Custom Type', 'polst' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'polst' ), /* Edit Dialog */
			'edit_item' => __( 'Edit Post Types', 'polst' ), /* Edit Display Title */
			'new_item' => __( 'New Post Type', 'polst' ), /* New Display Title */
			'view_item' => __( 'View Post Type', 'polst' ), /* View Display Title */
			'search_items' => __( 'Search Post Type', 'polst' ), /* Search Custom Type Title */ 
			...
			'description' => __( 'This is the example custom post type', 'polst' ), /* Custom Type Description */
			'public' => true,
