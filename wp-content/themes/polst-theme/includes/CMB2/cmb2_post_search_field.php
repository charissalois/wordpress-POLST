...
function cmb2_post_search_render_js(  $cmb_id, $object_id, $object_type, $cmb ) {
	...
	jQuery(document).ready(function($){
		...
		window.cmb2_post_search.addSearchButtons = function() {
			...
			$this.after( '<div title="'+ data.findtxt +'" class="dashicons dashicons-search button button-primary button-large cmb2-post-search-button" style="width: auto;" >Find Content</div>');
		};
